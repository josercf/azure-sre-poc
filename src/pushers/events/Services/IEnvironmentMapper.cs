...
public class EnvironmentMapper : IEnvironmentMapper
{
    ...
    {
        return _environmentTags["service.name"]?.ToString() ?? "events-pusher";
    }
    ...
    private Dictionary<string, object?> BuildEnvironmentTags()
    {
        ...
        // Service information
        tags["service.name"] = _configuration["OpenTelemetry:ServiceName"] ?? "events-pusher";
